      ...
      <main>
          ...
          <div className="max-w-[1400px] mx-auto flex flex-col lg:flex-row items-center gap-16 md:gap-24 lg:gap-32 w-full">
            ...
            <div className="lg:w-1/2 relative flex justify-center order-2 lg:order-1 scale-75 sm:scale-90 md:scale-100 lg:scale-105">
               ...
               <motion.div 
                 ...
                 className="absolute -top-10 -left-10 sm:-left-12 md:-left-24 p-5 md:p-6 bg-white dark:bg-[#1E1E1E] rounded-[2rem] md:rounded-[2.5rem] shadow-[0_40px_80px_-10px_rgba(0,0,0,0.08)] border border-gray-100 dark:border-white/10 space-y-3 md:space-y-4 hidden lg:block z-20"
               >
               ...
               <motion.div 
                 ...
                 className="absolute top-[40%] -right-10 sm:-right-12 md:-right-24 p-6 md:p-8 bg-[#0b0e14] dark:bg-primary text-white rounded-[2.5rem] md:rounded-[3rem] shadow-[0_60px_100px_-20px_rgba(0,0,0,0.3)] space-y-5 md:space-y-6 hidden lg:block w-60 md:w-72 z-20 overflow-hidden"
               >
        ...
        <section id="compliance" className="pt-32 pb-32 md:pt-48 md:pb-64 bg-white dark:bg-[#121212] text-center relative overflow-hidden transition-colors duration-500">
           ...
           <div className="absolute inset-0 bg-gradient-to-b from-gray-50/50 via-transparent to-gray-50/50 dark:from-black/10 dark:via-transparent dark:to-black/10 pointer-events-none z-0"></div>
            ...
            >
               {/* The Line - Animation Base at Bottom with Fade In/Out */}
               <motion.div
                 animate={{ 
                   opacity: [0, 0.6, 0.6, 0]
                 }}
               ...
               ></motion.div>
                ...
                <motion.div
                  ...
                  className="w-64 h-64 sm:w-96 sm:h-96 md:w-[28rem] md:h-[28rem] lg:w-[32rem] lg:h-[32rem] absolute bottom-[22%] left-[8%] -translate-y-full z-10"
                >
                  <DotLottieReact
                ...
                <motion.div
                  ...
                  className="absolute bottom-[22%] left-[8%] -translate-y-[320%] sm:-translate-y-[300%] md:-translate-y-[280%] z-0 filter grayscale opacity-20 pointer-events-none"
                >
                  <DotLottieReact 
                ...
                <motion.div
                  ...
                  className="w-24 h-24 sm:w-48 sm:h-48 md:w-56 md:h-56 lg:w-64 lg:h-64 absolute bottom-[22%] left-[25%] sm:left-[30%] -translate-y-full z-10"
                >
                  <DotLottieReact
                ...
                <motion.div
                  ...
                  className="w-24 h-24 sm:w-48 sm:h-48 md:w-56 md:h-56 lg:w-64 lg:h-64 absolute bottom-[22%] right-0 -translate-y-full z-10"
                >
                  <DotLottieReact
                ...
                <motion.div
                  ...
                  className="w-24 h-24 sm:w-48 sm:h-48 md:w-56 md:h-56 lg:w-64 lg:h-64 absolute bottom-[22%] left-1/2 -translate-x-1/2 -translate-y-full z-10"
                >
                  <DotLottieReact
              ...
              >
                 ...
                 <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center px-4">
                    <button className="h-14 md:h-16 px-8 bg-black dark:bg-primary text-white rounded-full flex items-center justify-center gap-4 hover:scale-105 transition-all shadow-xl active-press group w-full sm:w-auto">
                       <img src="/apple.png" alt="Apple" className="w-5 h-5 invert" onError={(e) => { (e.target as HTMLImageElement).src = '/apple.png'; }} />
                       <div className="text-left">
