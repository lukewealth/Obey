      ...
      <main>
        ...
        <section id="compliance" className="pt-32 pb-32 md:pt-48 md:pb-64 bg-white dark:bg-[#121212] text-center relative overflow-hidden transition-colors duration-500">
           ...
           >
              ...
              {/* Cat Animation - walking from extreme Right into center center */}
              <motion.div
                animate={{ 
                  x: ["100%", "0%"],
                  opacity: [0, 1, 1, 0]
                ...
                transition={{ 
                  duration: 18,
                  times: [0, 0.4, 0.66, 0.77], // Walks for ~7s, stays for ~5s, fades out at ~12s
                  repeat: Infinity, 
                  ease: "linear" 
                }}
                className="absolute top-1/2 left-1/2 -translate-y-[90%] z-10"
              >
                <DotLottieReact 
