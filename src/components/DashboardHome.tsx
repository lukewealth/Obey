    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-2">
          ...
          <p className="text-gray-500 font-medium text-base md:text-lg">Your financial ecosystem is performing optimally.</p>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="p-3 bg-white border border-gray-200 text-gray-600 rounded-[18px] md:rounded-[20px] hover:text-primary hover:bg-accent-blue transition-all shadow-sm active-press">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8">
        ...
        <motion.div 
          variants={itemVariants}
          className="lg:col-span-4 bg-gray-900 rounded-[35px] md:rounded-[45px] p-8 md:p-10 relative overflow-hidden flex flex-col justify-between shadow-2xl group text-white min-h-[280px] md:min-h-auto"
        >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
        {[
          ...
          >
            ...
            <div>
              <p className="text-lg md:text-xl font-black text-gray-900 tracking-tight">{action.label}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        >
          <div className="flex justify-between items-center mb-8 md:mb-10">
            <div>
              <h3 className="text-xl md:text-2xl font-black text-gray-900 tracking-tight">Financial Ledger</h3>
        ...
        <motion.section variants={itemVariants} className="lg:col-span-4 space-y-8">
              ...
              {[
                ...
                >
                  <div className="flex items-center gap-3 md:gap-4">
                    ...
                    <div>
                      <p className="text-sm md:text-base font-black text-gray-900 tracking-tight">{coin.name}</p>
          ...
          <div className="bg-accent-yellow/80 border border-yellow-200 rounded-[35px] md:rounded-[45px] p-8 md:p-10 relative overflow-hidden group shadow-xl">
             ...
             <div className="relative z-10 space-y-5 md:space-y-6">
              ...
              <button className="text-gray-900 text-[10px] md:text-xs font-black uppercase tracking-[0.2em] border-b-2 border-gray-900/10 hover:border-gray-900 transition-all pb-2">
                UPGRADE TO ELITE
              </button>
            </div>
          </div>
