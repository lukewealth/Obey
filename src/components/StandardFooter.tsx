...
export default function StandardFooter({ onNavigate }: StandardFooterProps) {
  return (
    <footer className="bg-[#f4f5f7] border-t border-gray-200 text-[#0b0e14] pt-24 pb-12 px-8 overflow-hidden relative">
      ...
      <div className="max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-24 mb-20">
          <div className="md:col-span-5 space-y-10">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-[#0b0e14] flex items-center justify-center rounded-[14px] shadow-2xl">
                <span className="text-white font-black text-xl tracking-tighter uppercase">O</span>
              </div>
              <span className="text-4xl font-black tracking-tighter font-space uppercase">OBEY</span>
            </div>
            ...
            <div className="flex items-center gap-6">
              <div className="flex flex-col">
                <p className="text-[10px] font-black uppercase text-gray-400 tracking-[0.2em] mb-1">Corporate Parent</p>
                <p className="text-sm font-bold text-[#0b0e14]">TRICODE PRO LTD</p>
              </div>
              ...
              <div className="flex flex-col">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-sm font-bold text-[#0b0e14]">Operational</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-8 hidden sm:block">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-3 p-3 bg-white border border-gray-100 rounded-xl shadow-sm">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-widest text-[#0b0e14]">256-Bit Encrypted</span>
                </div>
                <div className="flex items-center gap-3 p-3 bg-white border border-gray-100 rounded-xl shadow-sm">
                  <Lock size={18} className="text-primary" />
                  <span className="text-[10px] font-black uppercase tracking-widest text-[#0b0e14]">Biometric Auth</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="pt-12 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-8 text-[11px] font-black uppercase tracking-[0.2em] text-gray-400">
